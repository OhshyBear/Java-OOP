 ...
 * descending order for Strings. It is self written code 
		  ...
		  public static void asendingStringSort(String[] list) {
			  ...
			  for (i = 0; i < list.length - 1; ++i) {
		    	for(j = 0; j < list.length - 1; ++j) {
		    		...
		    		//compares each letter in the two strings similar to the compareTo() API
		    		for(k = 0; k < minLength; ++k) {
		    			//if the characters at the same position are of lesser ascii value then a swap is needed.
		    			if (str1.charAt(k) < str2.charAt(k)) {
		    				swap = true; //this is the only change that was needed from version 1 of my ascending code. It used to be in the else if statement. 
		    				break;
		    			//if the character at k in string 1 is greater then no swap is needed and we can stop looking.
